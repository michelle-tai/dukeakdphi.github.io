...
sakai.editor.editors.ckeditor.launch = function(targetId, config, w, h) {
    ...
    (function() {
        ...
        ckconfig.extraPlugins+="sakaipreview,image2,audiorecorder,contentitem,movieplayer,wordcount,notification,autosave,balloonpanel,a11ychecker,atd-ckeditor,warpwirecontentitem";

        // Load FontAwesome CSS in case a user wants to manually add FA markup
        ckconfig.contentsCss = [webJars+'fontawesome/4.7.0/css/font-awesome.min.css', basePath+'/atd-ckeditor/atd.css'];
